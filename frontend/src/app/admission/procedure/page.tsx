  ...
  return (
    <main>
      ...
      <section className="container" style={{ padding: '4rem 0' }}>
        <h2 style={{ color: 'var(--primary-color)', marginBottom: '2rem' }}>How to Apply</h2>
        <div style={{ display: 'grid', gap: '2rem' }}>
          <div className="glass-panel" style={{ padding: '2rem' }}>
            <h3 style={{ color: 'var(--accent-color)' }}>Step 1: Enquiry & Information Gathering</h3>
          ...
          <div className="glass-panel" style={{ padding: '2rem' }}>
            <h3 style={{ color: 'var(--accent-color)' }}>Step 2: Submission of Application Form</h3>
          ...
          <div className="glass-panel" style={{ padding: '2rem' }}>
            <h3 style={{ color: 'var(--accent-color)' }}>Step 3: Document Verification</h3>
          ...
          <div className="glass-panel" style={{ padding: '2rem' }}>
            <h3 style={{ color: 'var(--accent-color)' }}>Step 4: Final Admission & Fee Payment</h3>
