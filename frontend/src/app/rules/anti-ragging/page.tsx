  ...
  return (
    <main>
      ...
      <section className="container" style={{ padding: '4rem 0 6rem 0', maxWidth: '800px' }}>
        <div className="glass-panel card-3d" style={{ padding: '3rem', borderTop: '4px solid #ef4444' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '2rem' }}>
            <div style={{ fontSize: '3rem' }}>🛑</div>
            <div>
              <h2 style={{ color: '#ef4444', margin: '0 0 0.5rem 0' }} className="animate-on-load">Zero Tolerance Policy</h2>
          ...
          <h3 style={{ color: 'var(--text-primary)', marginBottom: '1rem' }} className="animate-on-load">Anti-Ragging Committee</h3>
