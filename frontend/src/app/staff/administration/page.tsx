    ...
    <main>
      ...
      <section className="container" style={{ padding: '4rem 0 6rem 0', minHeight: '50vh' }}>
        <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
          <h2 style={{ color: 'var(--primary-color)', fontSize: '2.5rem' }} className="animate-on-load">The Backbone of SAK College</h2>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem', maxWidth: '1000px', margin: '0 auto' }}>
          <div className="glass-panel card-3d" style={{ padding: '2rem', textAlign: 'center' }}>
            <h3 style={{ color: 'var(--text-primary)', marginBottom: '1rem' }} className="animate-on-load">Admission Cell</h3>
            <p style={{ color: 'var(--text-secondary)' }}>Handling all student enrollments, counseling, and document verification.</p>
          </div>
          <div className="glass-panel card-3d" style={{ padding: '2rem', textAlign: 'center' }}>
            <h3 style={{ color: 'var(--text-primary)', marginBottom: '1rem' }} className="animate-on-load">Accounts Department</h3>
            <p style={{ color: 'var(--text-secondary)' }}>Managing fee collections, scholarships, and financial assistance.</p>
          </div>
          <div className="glass-panel card-3d" style={{ padding: '2rem', textAlign: 'center' }}>
            <h3 style={{ color: 'var(--text-primary)', marginBottom: '1rem' }} className="animate-on-load">Hostel Wardens</h3>
            <p style={{ color: 'var(--text-secondary)' }}>Ensuring the safety, discipline, and well-being of residential students.</p>
          </div>
          <div className="glass-panel card-3d" style={{ padding: '2rem', textAlign: 'center' }}>
            <h3 style={{ color: 'var(--text-primary)', marginBottom: '1rem' }} className="animate-on-load">Library & IT Support</h3>
